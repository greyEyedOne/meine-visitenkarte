    ...
    <body>
      <main>
        ...
        <p>
          ...
          Ave #4133, Covina, CA 91723, USA gehostet. Beim Aufruf der Seiten
          übermittelt Ihr Browser automatisch technische Zugriffsdaten (z. B.
        ...
        <p>
          ...
          Zudem haben Sie ein Beschwerderecht bei einer Aufsichtsbehörde. Für
        ...
        <h2>5. Änderungen</h2>
        <p>
          Diese Datenschutzerklärung kann bei Bedarf aktualisiert werden, um sie
          an rechtliche oder technische Entwicklungen anzupassen.
        </p>
      </main>
    </body>
  </html>
